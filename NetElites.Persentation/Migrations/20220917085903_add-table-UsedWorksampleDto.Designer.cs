...
namespace NetElites.Persentation.Migrations
{
    ...
    [Migration("20220917085903_add-table-UsedWorksampleDto")]
    partial class addtableUsedWorksampleDto
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetElites.Domain.Model.Worksamples.Worksample", b =>
                {
                    ...
                    b.Property<int?>("UsedWorksampleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NetElites.Doamin.Model.Tag", b =>
                {
                    b.HasOne("NetElites.Doamin.Model.Tag", null)
                        .WithMany("Tags")
                        .HasForeignKey("TagId");
                });
            ...
            modelBuilder.Entity("NetElites.Domain.Model.Articles.Article", b =>
                {
                    b.HasOne("NetElites.Doamin.Model.Tag", "Tag")
                        .WithMany("Articles")
                        .HasForeignKey("Tagid");
            ...
            modelBuilder.Entity("NetElites.Domain.Model.Worksamples.Worksample", b =>
                {
                    ...
                    b.HasOne("NetElites.Doamin.Model.Worksamples.UsedWorksample", "UsedWorksample")
                        .WithMany("Worksamples")
                        .HasForeignKey("UsedWorksampleId");

                    b.Navigation("Tag");

                    b.Navigation("UsedWorksample");
                });
